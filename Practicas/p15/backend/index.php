<?php
    ...
    $app->get('/list', function($request, $response, $args){
        ...
        $products = new Read("root", "IMREDj2128@", "marketzone");
    ...
    $app->post('/add', function($request, $response, $args){
        ...
        $products = new Create("root", "IMREDj2128@", "marketzone");
    ...
    $app->post('/edit', function($request, $response, $args){
        ...
        $products = new Update("root", "IMREDj2128@", "marketzone");
    ...
    $app->post('/delete', function($request, $response, $args){
        ...
        $products = new Delete("root", "IMREDj2128@", "marketzone");
